...
variants. Images default to `ghcr.io/dbent/archlinux`; override `IMAGE`
when a different local name or registry is required:
...
[DBB Agent Skills](https://git.dbb.dev/dbb/skills). In a separate
checkout of that collection, run:
